...
<head>
    ...
    <title>Daftar - Sistem Perpustakaan MTs Muhamadyah</title>
    ...
    <div class="max-w-md w-full space-y-8 p-8">
        <div class="bg-white rounded-lg shadow-xl p-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 mt-2">Sistem Perpustakaan MTs Muhamadyah</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div class="relative">
                    ...
                    <span id="togglePasswordConfirm" class="absolute right-3 top-9 cursor-pointer text-gray-500 hover:text-blue-600">
                        <i class="fas fa-eye"></i>
                    </span>
                </div>
